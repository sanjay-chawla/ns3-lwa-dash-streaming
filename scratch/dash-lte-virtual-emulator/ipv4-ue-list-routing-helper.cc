...
Ipv4UeListRoutingHelper::Ipv4UeListRoutingHelper()
{
}
...
Ipv4UeListRoutingHelper::Ipv4UeListRoutingHelper (const Ipv4UeListRoutingHelper &o)
{
...
{
  return new Ipv4UeListRoutingHelper (*this);
}

void
Ipv4UeListRoutingHelper::Add (const Ipv4RoutingHelper &routing, int16_t priority)
{
  m_list.push_back (std::make_pair (const_cast<const Ipv4RoutingHelper *> (routing.Copy ()), priority));
}

Ptr<Ipv4RoutingProtocol>
Ipv4UeListRoutingHelper::Create (Ptr<Node> node) const
{
  Ptr<Ipv4UeListRouting> list = CreateObject<Ipv4UeListRouting> ();
