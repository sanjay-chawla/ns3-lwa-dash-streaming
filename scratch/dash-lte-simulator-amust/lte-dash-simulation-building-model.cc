...
ApplicationContainer GetDASHClientApplication (string ssMPDURL, Ptr<Node> ueNode, double simTime, uint32_t remoteHostId){
 ...
 //   LogComponentEnable ("PfFfMacScheduler", LOG_LEVEL_ALL);
   ...
   if (outdoorUeMaxSpeed!=0.0)
     {
       ...
       Config::SetDefault ("ns3::SteadyStateRandomWaypointMobilityModel::MaxPause", DoubleValue (0));
   ...
   outputDirStream << "output/lte/dualstripe/ues" << macroUeDensity*100000 << "_" << dashSegmentDuration << "s/";
